 ...
 */
/* function labbar() {                Labbar commented away, feature not done
...
function home() {
    ...
    //document.getElementById("bookimg").style.filter = "invert(100%) sepia(100%) saturate(100%) hue-rotate(157deg) brightness(100%) contrast(100%)";        Labbar commented away, feature not done
    document.getElementById("engineerimg").style.filter = "invert(100%) sepia(100%) saturate(100%) hue-rotate(157deg) brightness(100%) contrast(100%)";
}
